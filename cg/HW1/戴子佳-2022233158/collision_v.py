...
import math
import time
from collision import RigidBody, SAT3D
...
if __name__ == "__main__":
    ...
    parser.add_argument('-m1', type=str, required=True, help='/data/Armadillo_convhull.obj')
    parser.add_argument('-ch1', type=str, required=True, help='/data/Armadillo_convhull_n.obj')
    parser.add_argument('-m2', type=str, required=True, help='/data/bunny_convhull.obj')
    parser.add_argument('-ch2', type=str, required=True, help='/data/bunny_convhull_n.obj')
